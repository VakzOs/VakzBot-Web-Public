...
export const categories: Category[] = [
  ...
  },
  {
    ...
    modules: [
      { name: 'Musique', description: 'Lecture dans les salons vocaux (YouTube, Spotify…) via Lavalink.' },
      { name: 'Jeux', description: 'Mini-jeux, statistiques et drops d’objets par rareté.' },
      { name: 'Objets', description: 'Inventaire, objets à collectionner, à échanger et à gagner en jeu.' },
...
export const commands: CommandItem[] = [
  ...
  { name: '/play', description: 'Joue de la musique dans ton salon vocal (recherche ou lien).' },
